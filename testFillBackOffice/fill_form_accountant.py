...
from testFillBackOffice.business_types import BusinessType
...
class AccountantAvivaCustomerFrontendFormFill(
    ...
    def fill_page1(self):
        ...
        self.input_text('//*[@ng-reflect-name="businessDescription"]', 'some description', exception_message='Business description textbox on page 1')
    ...
    def test(self, stop_at_page = 6, keep_open = False):
        ...
        self.login()
        sleep(1)
        self.click_element('//app-site-menu/div/a[2]')
        sleep(0.2)
