...
try:
    from testFillBackOffice.fill_form_plumber import form_filler  
...
try:
    from testFillBackOffice.fill_form_acoustic_consultant import form_filler
    page1_time, page2_time, page3_time, page3_time, page5_time = form_filler.test(6)
...
try:
    from testFillBackOffice.fill_form_accountant import form_filler
    page1_time, page2_time, page3_time, page3_time, page5_time = form_filler.test(6)
...
try:
    from testFillBackOffice.fill_form_cafe import form_filler
    page1_time, page2_time, page3_time, page3_time, page5_time = form_filler.test(6)
